...
## (1) SalesIncome和LaborIncome類別都實作了Revenue介面
...
// 類別, 它實作了Revenue介面
//----------------------------
public class LaborIncome implements Revenue{
    //======================== 
    // 成員
    //======================== 
    private LocalDate date;
...
public class Main {
    ...
    // 印出資料的方法
    //=============================
    public static void printInfo(List<Revenue> list){
        list.forEach(data  -> {
