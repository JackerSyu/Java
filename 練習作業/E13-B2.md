...
```
3. 倉儲租用的[租金]由租用坪數決定, 每坪每20天租金250元; 不足20天的餘數每坪每天30元.
   例如: 租用100坪, 租85天, 租金 = (250 * 100 * 4) + (30 * 100 * 5) = 115,000元.  
   
4. 以下是[倉儲租用]輸出範例:    
   租用類別:倉儲租用, 起始日:2018-12-21, 終止日:2018-12-31, 日數:11, 坪數:20, 租金:6,600元
```
...
public class WarehouseRental extends Rental{
    ...
    // 建構元(1)
    //=====================    
    public WarehouseRental(String category, LocalDate startDate, LocalDate endDate){        
        //自行完成
    }
